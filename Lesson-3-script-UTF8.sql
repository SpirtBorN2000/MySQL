...
-- Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ Начало ДЗ
...
CREATE TABLE `music` (
	...
	FOREIGN KEY (playlist_id) REFERENCES music_playlists(id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (media_id) REFERENCES media(id) ON UPDATE CASCADE ON DELETE CASCADE
...
CREATE TABLE users_games(
	...
	PRIMARY KEY (user_id, game_id), -- Опять же проблема с 1,2 и 2,1 которую непонятно как решить
    FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE,
